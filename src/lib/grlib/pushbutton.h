...
#define CircularButtonStruct(psParent,                                         \
    ...
    {                                                                          \
        {sizeof(tPushButtonWidget),                                            \
         ...
         (tWidget*)(psNext),                                                   \
         (tWidget*)(psChild),                                                  \
         psDisplay, {(i32X) - (i32R), (i32Y) - (i32R), (i32X) + (i32R), (i32Y) + (i32R)}, \
...
#define CircularButton(sName,                                           \
                       ...
                       ui16AutoRepeatRate,                              \
                       pfnOnClick)                                      \
    tPushButtonWidget sName = CircularButtonStruct(psParent,            \
                                                   psNext,              \
                                                   psChild,             \
                                                   psDisplay,           \
                                                   i32X,                \
...
#define RectangularButton(sName,                                           \
                          ...
                          ui16AutoRepeatRate,                              \
                          pfnOnClick)                                      \
    tPushButtonWidget sName = RectangularButtonStruct(psParent,            \
                                                      psNext,              \
                                                      psChild,             \
                                                      psDisplay,           \
                                                      i32X,                \
...
//
//*****************************************************************************
extern int32_t RectangularButtonMsgProc(tWidget* psWidget, uint32_t ui32Msg, uint32_t ui32Param1, uint32_t ui32Param2);
extern void    RectangularButtonInit(tPushButtonWidget* psWidget,
                                     ...
                                     int32_t            i32Width,
                                     int32_t            i32Height);
extern int32_t CircularButtonMsgProc(tWidget* psWidget, uint32_t ui32Msg, uint32_t ui32Param1, uint32_t ui32Param2);
extern void    CircularButtonInit(tPushButtonWidget* psWidget, const tDisplay* psDisplay, int32_t i32X, int32_t i32Y, int32_t i32R);
