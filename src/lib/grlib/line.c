...
void GrLineDrawH(const tContext* pContext, int32_t i32X1, int32_t i32X2, int32_t i32Y)
{
    ...
    //
    if ((i32Y < pContext->sClipRegion.i16YMin) || (i32Y > pContext->sClipRegion.i16YMax))
    {
        return;
    }
    ...
    // to be done.
    //
    if ((i32X1 > pContext->sClipRegion.i16XMax) || (i32X2 < pContext->sClipRegion.i16XMin))
    {
        return;
    }
...
void GrLineDrawV(const tContext* pContext, int32_t i32X, int32_t i32Y1, int32_t i32Y2)
{
    ...
    // there is nothing to be done.
    //
    if ((i32X < pContext->sClipRegion.i16XMin) || (i32X > pContext->sClipRegion.i16XMax))
    {
        return;
    }
    ...
    // to be done.
    //
    if ((i32Y1 > pContext->sClipRegion.i16YMax) || (i32Y2 < pContext->sClipRegion.i16YMin))
    {
        return;
    }
...
//
//*****************************************************************************
static int32_t GrLineClip(const tContext* pContext, int32_t* pi32X1, int32_t* pi32Y1, int32_t* pi32X2, int32_t* pi32Y2)
{
    ...
    while (1)
    {
        ...
        if (i32Code & 1)
        {
            ...
            //
            i32X = (*pi32X1 + (((*pi32X2 - *pi32X1) * (pContext->sClipRegion.i16YMin - *pi32Y1)) / (*pi32Y2 - *pi32Y1)));
        ...
        else if (i32Code & 2)
        {
            ...
            //
            i32X = (*pi32X1 + (((*pi32X2 - *pi32X1) * (pContext->sClipRegion.i16YMax - *pi32Y1)) / (*pi32Y2 - *pi32Y1)));
        ...
        else if (i32Code & 4)
        {
            ...
            i32Y = (*pi32Y1 + (((*pi32Y2 - *pi32Y1) * (pContext->sClipRegion.i16XMin - *pi32X1)) / (*pi32X2 - *pi32X1)));
        }
        ...
        else
        {
            ...
            i32Y = (*pi32Y1 + (((*pi32Y2 - *pi32Y1) * (pContext->sClipRegion.i16XMax - *pi32X1)) / (*pi32X2 - *pi32X1)));
        }
...
//
//*****************************************************************************
void GrLineDraw(const tContext* pContext, int32_t i32X1, int32_t i32Y1, int32_t i32X2, int32_t i32Y2)
{
    ...
    //
    if (((i32Y2 > i32Y1) ? (i32Y2 - i32Y1) : (i32Y1 - i32Y2)) > ((i32X2 > i32X1) ? (i32X2 - i32X1) : (i32X1 - i32X2)))
    {
        bSteep = 1;
    }
    else
    ...
    for (; i32X1 <= i32X2; i32X1++)
    {
        ...
        if (bSteep)
        {
            ...
            //
            DpyPixelDraw(pContext->psDisplay, i32Y1, i32X1, pContext->ui32Foreground);
        }
        else
        {
            //
            ...
            //
            DpyPixelDraw(pContext->psDisplay, i32X1, i32Y1, pContext->ui32Foreground);
        }
