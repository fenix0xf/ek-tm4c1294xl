...
const uint16_t g_pui16ISO8859_3_Unicode[] = {
    0x0126, 0x02D8, 0x00A3, 0x00A4, 0x0000, 0x0124, 0x00A7, 0x00A8, 0x0130, 0x015E, 0x011E, 0x0134, 0x00AD, 0x0000, 0x017B, 0x00B0,
    0x0127, 0x00B2, 0x00B3, 0x00B4, 0x00B5, 0x0125, 0x00B7, 0x00B8, 0x0131, 0x015F, 0x011F, 0x0135, 0x00BD, 0x0000, 0x017C, 0x00C0,
    0x00C1, 0x00C2, 0x0000, 0x00C4, 0x010A, 0x0108, 0x00C7, 0x00C8, 0x00C9, 0x00CA, 0x00CB, 0x00CC, 0x00CD, 0x00CE, 0x00CF, 0x0000,
    0x00D1, 0x00D2, 0x00D3, 0x00D4, 0x0120, 0x00D6, 0x00D7, 0x011C, 0x00D9, 0x00DA, 0x00DB, 0x00DC, 0x016C, 0x015C, 0x00DF, 0x00E0,
    0x00E1, 0x00E2, 0x0000, 0x00E4, 0x010B, 0x0109, 0x00E7, 0x00E8, 0x00E9, 0x00EA, 0x00EB, 0x00EC, 0x00ED, 0x00EE, 0x00EF, 0x0000,
    0x00F1, 0x00F2, 0x00F3, 0x00F4, 0x0121, 0x00F6, 0x00F7, 0x011D, 0x00F9, 0x00FA, 0x00FB, 0x00FC, 0x016D, 0x015D, 0x02D9};
...
//
//*****************************************************************************
const uint16_t g_pui16ISO8859_7_Unicode[] = {0x2018, 0x2019, 0x00A3, 0x20AC, 0x20AF, 0x00A6, 0x00A7, 0x00A8, 0x00A9, 0x037A,
                                             0x00AB, 0x00AC, 0x00AD, 0x0000, 0x2015, 0x00B0, 0x00B1, 0x00B2, 0x00B3, 0x0384,
                                             0x0385, 0x0386, 0x00B7, 0x0388, 0x0389, 0x038A, 0x00BB, 0x038C, 0x00BD};
...
//
//*****************************************************************************
const uint16_t g_pui16ISO8859_14_Unicode[] = {0x1E02, 0x1E03, 0x00A3, 0x010A, 0x010B, 0x1E0A, 0x00A7, 0x1E80, 0x00A9, 0x1E82, 0x1E0B,
...
const uint16_t g_pui16ISO8859_16_Unicode[] = {
    0x0104, 0x0105, 0x0141, 0x20AC, 0x201E, 0x0160, 0x00A7, 0x0161, 0x00A9, 0x0218, 0x00AB, 0x0179, 0x00AD, 0x017A, 0x017B, 0x00B0,
    0x00B1, 0x010C, 0x0142, 0x017D, 0x201D, 0x00B6, 0x00B7, 0x017E, 0x010D, 0x0219, 0x00BB, 0x0152, 0x0153, 0x0178, 0x017C, 0x00C0,
    0x00C1, 0x00C2, 0x0102, 0x00C4, 0x0106, 0x00C6, 0x00C7, 0x00C8, 0x00C9, 0x00CA, 0x00CB, 0x00CC, 0x00CD, 0x00CE, 0x00CF, 0x0110,
    0x0143, 0x00D2, 0x00D3, 0x00D4, 0x0150, 0x00D6, 0x015A, 0x0170, 0x00D9, 0x00DA, 0x00DB, 0x00DC, 0x0118, 0x021A, 0x00DF, 0x00E0,
    0x00E1, 0x00E2, 0x0103, 0x00E4, 0x0107, 0x00E6, 0x00E7, 0x00E8, 0x00E9, 0x00EA, 0x00EB, 0x00EC, 0x00ED, 0x00EE, 0x00EF, 0x0111,
    0x0144, 0x00F2, 0x00F3, 0x00F4, 0x0151, 0x00F6, 0x015B, 0x0171, 0x00F9, 0x00FA, 0x00FB, 0x00FC, 0x0119, 0x021B, 0x00FF};
...
//
//*****************************************************************************
const uint16_t g_pui16WIN1254_Unicode[] = {0x20AC, 0,      0x201A, 0x0192, 0x201E, 0x2026, 0x2020, 0x2021, 0x02C6, 0x2030, 0x0160,
                                           0x2039, 0x0152, 0,      0,      0,      0,      0x2018, 0x2019, 0x201C, 0x201D, 0x2022,
                                           0x2013, 0x2014, 0x02DC, 0x2122, 0x0161, 0x203A, 0x0153, 0,      0,      0x0178};
...
//
//*****************************************************************************
uint32_t       GrMapISO8859_1_Unicode(const char* pcSrcChar, uint32_t ui32Count, uint32_t* pui32Skip)
{
    //
...
//
//*****************************************************************************
uint32_t GrMapISO8859_2_Unicode(const char* pcSrcChar, uint32_t ui32Count, uint32_t* pui32Skip)
{
    //
    // Parameter sanity check.
    //
    ...
    *pui32Skip = 1;
    ...
    {
        return ((uint32_t)g_pui16ISO8859_2_Unicode[(char)*pcSrcChar - 0xA1]);
    }
}
...
//
//*****************************************************************************
uint32_t GrMapISO8859_3_Unicode(const char* pcSrcChar, uint32_t ui32Count, uint32_t* pui32Skip)
{
    //
    // Parameter sanity check.
    //
    ...
    *pui32Skip = 1;
    ...
    {
        return ((uint32_t)g_pui16ISO8859_3_Unicode[(uint8_t)*pcSrcChar - 0xA1]);
    }
}
...
//
//*****************************************************************************
uint32_t GrMapISO8859_4_Unicode(const char* pcSrcChar, uint32_t ui32Count, uint32_t* pui32Skip)
{
    //
    // Parameter sanity check.
    //
    ...
    *pui32Skip = 1;
    ...
    {
        return ((uint32_t)g_pui16ISO8859_4_Unicode[(uint8_t)*pcSrcChar - 0xA1]);
    }
}
...
//
//*****************************************************************************
uint32_t GrMapISO8859_5_Unicode(const char* pcSrcChar, uint32_t ui32Count, uint32_t* pui32Skip)
{
    //
    // Parameter sanity check.
    //
...
//
//*****************************************************************************
uint32_t GrMapISO8859_6_Unicode(const char* pcSrcChar, uint32_t ui32Count, uint32_t* pui32Skip)
{
    //
    // Parameter sanity check.
    //
    ...
    *pui32Skip = 1;
    ...
    // Is this character one of those which maps directly to Unicode?
    //
    if (((uint8_t)*pcSrcChar <= 0xA4) || ((uint8_t)*pcSrcChar == 0xAD))
    {
        return ((uint32_t)(uint8_t)*pcSrcChar);
    }
    else
...
//
//*****************************************************************************
uint32_t GrMapISO8859_10_Unicode(const char* pcSrcChar, uint32_t ui32Count, uint32_t* pui32Skip)
{
    //
    // Parameter sanity check.
    //
    ...
    *pui32Skip = 1;
    ...
    {
        return ((uint32_t)g_pui16ISO8859_10_Unicode[(uint8_t)*pcSrcChar - 0xA1]);
    }
}
...
//
//*****************************************************************************
uint32_t GrMapISO8859_11_Unicode(const char* pcSrcChar, uint32_t ui32Count, uint32_t* pui32Skip)
{
    //
    // Parameter sanity check.
    //
...
//
//*****************************************************************************
uint32_t GrMapISO8859_13_Unicode(const char* pcSrcChar, uint32_t ui32Count, uint32_t* pui32Skip)
{
    //
    // Parameter sanity check.
    //
...
//
//*****************************************************************************
uint32_t GrMapISO8859_14_Unicode(const char* pcSrcChar, uint32_t ui32Count, uint32_t* pui32Skip)
{
    //
    // Parameter sanity check.
    //
    ...
    *pui32Skip = 1;
    ...
    switch ((uint8_t)*pcSrcChar)
    {
        ...
        default:
        {
            ...
            {
                return ((uint32_t)g_pui16ISO8859_14_Unicode[(uint8_t)*pcSrcChar - 0xA1]);
            }
        }
    }
}
...
//
//*****************************************************************************
uint32_t GrMapISO8859_15_Unicode(const char* pcSrcChar, uint32_t ui32Count, uint32_t* pui32Skip)
{
    //
    // Parameter sanity check.
    //
...
//
//*****************************************************************************
uint32_t GrMapISO8859_16_Unicode(const char* pcSrcChar, uint32_t ui32Count, uint32_t* pui32Skip)
{
    //
    // Parameter sanity check.
    //
    ...
    *pui32Skip = 1;
    ...
    {
        return ((uint32_t)g_pui16ISO8859_16_Unicode[(uint8_t)*pcSrcChar - 0xA1]);
    }
}
...
uint32_t GrMapUTF8_Unicode(const char* pcSrcChar, uint32_t ui32Count, uint32_t* pui32Skip)
{
    ...
    else
    {
        ...
        // it uses.
        //
        ui32ToRead = NumLeadingZeros(~((uint32_t)pcSrcChar[ui32Index] << 24)) - 1;
        ...
        else
        {
            ...
            //
            ui32Unicode = (uint8_t)pcSrcChar[ui32Index++] & ((1 << (6 - ui32ToRead)) - 1);
            ...
            while (ui32Count && ui32ToRead)
            {
                ...
                else
                {
                    ...
                    //
                    ui32Unicode = ((ui32Unicode << 6) | ((uint8_t)pcSrcChar[ui32Index++] & 0x3F));
                    ui32ToRead--;
                    ui32Count--;
                }
            }
...
//
//*****************************************************************************
static uint32_t GrMapUTF16_Unicode(const char* pcSrcChar, uint32_t ui32Count, uint32_t* pui32Skip, bool bLE)
{
    ...
    while (ui32Count >= 2)
    {
        ...
        //
        ui16Char = bLE ? (pcChar[0] + 256 * pcChar[1]) : (pcChar[1] + 256 * pcChar[0]);
        ...
        else
        {
            ...
            if ((ui16Char >= 0xD800) && (ui16Char < 0xDC00))
            {
                ...
                if (ui32Count >= 2)
                {
                    ...
                    //
                    ui16CharToo = bLE ? (pcChar[0] + 256 * pcChar[1]) : (pcChar[1] + 256 * pcChar[0]);
                    ...
                    if ((ui16CharToo >= 0xDC00) && (ui16CharToo < 0xE000))
                    {
                        ...
                        pcChar    += 2;
                        ui32Count -= 2;
                        ui32Code   = 0x10000 + ((uint32_t)(ui16Char - 0xD800) << 10) + ((uint32_t)ui16CharToo - 0xDC00);
                        break;
                    }
                }
            }
...
uint32_t GrMapUnicode_Unicode(const char* pcSrcChar, uint32_t ui32Count, uint32_t* pui32Skip)
{
    ...
    else
    {
        ...
        //
        *pui32Skip = 4;
        return (pcSrcChar[0] | (pcSrcChar[1] << 8) | (pcSrcChar[2] << 16) | (pcSrcChar[3] << 24));
    }
}
...
uint32_t GrMapWIN1250_Unicode(const char* pcSrcChar, uint32_t ui32Count, uint32_t* pui32Skip)
{
    ...
    *pui32Skip = 1;
    ...
    {
        return ((uint32_t)g_pui16WIN1250_Unicode[(uint8_t)*pcSrcChar - 0x80]);
    }
}
...
uint32_t GrMapWIN1251_Unicode(const char* pcSrcChar, uint32_t ui32Count, uint32_t* pui32Skip)
{
    ...
    *pui32Skip = 1;
    ...
    else if (((uint8_t)*pcSrcChar >= 0x80) && ((uint8_t)*pcSrcChar <= 0xBF))
    {
        return ((uint32_t)g_pui16WIN1251_Unicode[(uint8_t)*pcSrcChar - 0x80]);
    }
    else
    {
...
uint32_t GrMapWIN1252_Unicode(const char* pcSrcChar, uint32_t ui32Count, uint32_t* pui32Skip)
{
    ...
    *pui32Skip = 1;
    ...
    // Is this character one of those which maps directly to Unicode?
    //
    if (((uint8_t)*pcSrcChar <= 0x7F) || ((uint8_t)*pcSrcChar >= 0xA0))
    {
        return ((uint32_t)(uint8_t)*pcSrcChar);
    }
    else
    {
        return ((uint32_t)g_pui16WIN1252_Unicode[(uint8_t)*pcSrcChar - 0x80]);
    }
}
...
uint32_t GrMapWIN1253_Unicode(const char* pcSrcChar, uint32_t ui32Count, uint32_t* pui32Skip)
{
    ...
    *pui32Skip = 1;
    ...
    else if (((uint8_t)*pcSrcChar >= 0x80) && ((uint8_t)*pcSrcChar <= 0xBF))
    {
        ...
        //
        return ((uint32_t)g_pui16WIN1253_Unicode[(uint8_t)*pcSrcChar - 0x80]);
    }
    else
    {
        //
...
uint32_t GrMapWIN1254_Unicode(const char* pcSrcChar, uint32_t ui32Count, uint32_t* pui32Skip)
{
    ...
    *pui32Skip = 1;
    ...
    else
    {
        ...
        // This is a character we remap via the global table.
        //
        return ((uint32_t)g_pui16WIN1254_Unicode[(uint8_t)*pcSrcChar - 0x80]);
    }
}
