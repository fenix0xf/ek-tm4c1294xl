...
#define ListBox(sName,                                         \
                ...
                ui16PopulatedEntries,                          \
                pfnOnChange)                                   \
    tListBoxWidget sName = ListBoxStruct(psParent,             \
                                         psNext,               \
                                         psChild,              \
                                         psDisplay,            \
                                         i32X,                 \
...
//
//*****************************************************************************
#define ListBoxSelectionGet(psWidget) (((tListBoxWidget*)(psWidget))->i16Selected)
...
//
//*****************************************************************************
extern int32_t ListBoxMsgProc(tWidget* psWidget, uint32_t ui32Msg, uint32_t ui32Param1, uint32_t ui32Param2);
extern void    ListBoxInit(tListBoxWidget* psWidget,
