...
void GrRectDraw(const tContext* pContext, const tRectangle* pRect)
{
    ...
    //
    GrLineDrawV(pContext, pRect->i16XMin, pRect->i16YMax - 1, pRect->i16YMin + 1);
}
...
void GrRectFill(const tContext* pContext, const tRectangle* pRect)
{
    ...
    //
    if ((sTemp.i16XMin > pContext->sClipRegion.i16XMax) || (sTemp.i16XMax < pContext->sClipRegion.i16XMin) ||
        (sTemp.i16YMin > pContext->sClipRegion.i16YMax) || (sTemp.i16YMax < pContext->sClipRegion.i16YMin))
    {
        return;
    }
...
{
    if ((psRect1->i16XMax < psRect2->i16XMin) || (psRect2->i16XMax < psRect1->i16XMin) || (psRect1->i16YMax < psRect2->i16YMin) ||
...
int32_t GrRectIntersectGet(tRectangle* psRect1, tRectangle* psRect2, tRectangle* psIntersect)
{
    ...
    //
    if ((psRect1->i16XMax <= psRect1->i16XMin) || (psRect1->i16YMax <= psRect1->i16YMin) || (psRect2->i16XMax <= psRect2->i16XMin) ||
