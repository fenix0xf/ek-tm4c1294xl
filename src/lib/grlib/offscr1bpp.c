...
#define DPYCOLORTRANSLATE(c) \
    ((((((c) & 0x00ff0000) >> 16) * 19661) + ((((c) & 0x0000ff00) >> 8) * 38666) + (((c) & 0x000000ff) * 7209)) / (65536 * 128))
...
//
//*****************************************************************************
static void GrOffScreen1BPPPixelDraw(void* pvDisplayData, int32_t i32X, int32_t i32Y, uint32_t ui32Value)
{
    uint8_t* pui8Data;
...
//
//*****************************************************************************
static void GrOffScreen1BPPPixelDrawMultiple(void*          pvDisplayData,
                                             int32_t        i32X,
                                             int32_t        i32Y,
                                             int32_t        i32X0,
                                             int32_t        i32Count,
        ...
        case 1:
        {
            ...
            while (i32Count)
            {
                ...
                for (; (i32X0 < 8) && i32Count; i32X0++, i32Count--)
                {
                    ...
                    //
                    *pui8Ptr = ((*pui8Ptr & ~(1 << i32X)) | ((((uint32_t*)pui8Palette)[(ui32Byte >> (7 - i32X0)) & 1]) << i32X));
                    if (i32X-- == 0)
                    {
                        i32X = 7;
                        pui8Ptr++;
            ...
            switch (i32X0 & 1)
            {
                case 0:
                    while (i32Count)
                    {
                        ...
                        // screen.
                        //
                        *pui8Ptr = ((*pui8Ptr & ~(1 << i32X)) | (DPYCOLORTRANSLATE(ui32Byte) << i32X));
                        if (i32X-- == 0)
                        {
                            i32X = 7;
                            pui8Ptr++;
...
//
//*****************************************************************************
static void GrOffScreen1BPPLineDrawH(void* pvDisplayData, int32_t i32X1, int32_t i32X2, int32_t i32Y, uint32_t ui32Value)
{
...
//
//*****************************************************************************
static void GrOffScreen1BPPLineDrawV(void* pvDisplayData, int32_t i32X, int32_t i32Y1, int32_t i32Y2, uint32_t ui32Value)
{
    uint8_t* pui8Data;
    int32_t  i32BytesPerRow;
...
//
//*****************************************************************************
static void GrOffScreen1BPPRectFill(void* pvDisplayData, const tRectangle* pRect, uint32_t ui32Value)
{
...
//
//*****************************************************************************
static uint32_t GrOffScreen1BPPColorTranslate(void* pvDisplayData, uint32_t ui32Value)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static void GrOffScreen1BPPFlush(void* pvDisplayData)
{
    //
    // Check the arguments.
    //
