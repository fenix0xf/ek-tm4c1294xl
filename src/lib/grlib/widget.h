...
typedef struct __Widget
{
    ...
    //
    int32_t (*pfnMsgProc)(struct __Widget* psWidget, uint32_t ui32Message, uint32_t ui32Param1, uint32_t ui32Param2);
} tWidget;
...
//
//*****************************************************************************
#define WidgetPaint(psWidget) WidgetMessageQueueAdd(psWidget, WIDGET_MSG_PAINT, 0, 0, false, false)
...
extern int32_t  WidgetDefaultMsgProc(tWidget* psWidget, uint32_t ui32Message, uint32_t ui32Param1, uint32_t ui32Param2);
...
extern uint32_t WidgetMessageSendPostOrder(tWidget* psWidget,
                                           ...
                                           uint32_t ui32Param2,
                                           bool     bStopOnSuccess);
extern int32_t  WidgetMessageQueueAdd(tWidget* psWidget,
                                      uint32_t ui32Message,
                                      uint32_t ui32Param1,
                                      uint32_t ui32Param2,
                                      bool     bPostOrder,
...
extern int32_t  WidgetPointerMessage(uint32_t ui32Message, int32_t i32X, int32_t i32Y);
