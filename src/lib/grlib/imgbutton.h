...
#define ImageButton(sName,                                            \
                    ...
                    ui16AutoRepeatRate,                               \
                    pfnOnClick)                                       \
    tImageButtonWidget sName = ImageButtonStruct(psParent,            \
                                                 psNext,              \
                                                 psChild,             \
                                                 psDisplay,           \
                                                 i32X,                \
...
//
//*****************************************************************************
extern int32_t ImageButtonMsgProc(tWidget* psWidget, uint32_t ui32Msg, uint32_t ui32Param1, uint32_t ui32Param2);
