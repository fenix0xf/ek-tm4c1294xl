...
//
//*****************************************************************************
#define CANVAS_STYLE_TEXT_OPAQUE  0x00000020
...
//
//*****************************************************************************
#define CANVAS_STYLE_TEXT_LEFT    0x00000040
...
//
//*****************************************************************************
#define CANVAS_STYLE_TEXT_RIGHT   0x00000080
...
//
//*****************************************************************************
#define CANVAS_STYLE_TEXT_TOP     0x00000100
...
//
//*****************************************************************************
#define CANVAS_STYLE_TEXT_BOTTOM  0x00000200
...
//
//*****************************************************************************
#define CANVAS_STYLE_ALIGN_MASK   (CANVAS_STYLE_TEXT_LEFT | CANVAS_STYLE_TEXT_RIGHT | CANVAS_STYLE_TEXT_TOP | CANVAS_STYLE_TEXT_BOTTOM)
#define CANVAS_STYLE_ALIGN_HMASK  (CANVAS_STYLE_TEXT_LEFT | CANVAS_STYLE_TEXT_RIGHT)
#define CANVAS_STYLE_ALIGN_VMASK  (CANVAS_STYLE_TEXT_TOP | CANVAS_STYLE_TEXT_BOTTOM)
...
#define Canvas(sName,                                    \
               ...
               pui8Image,                                \
               pfnOnPaint)                               \
    tCanvasWidget sName = CanvasStruct(psParent,         \
                                       psNext,           \
                                       psChild,          \
                                       psDisplay,        \
                                       i32X,             \
...
//
//*****************************************************************************
extern int32_t CanvasMsgProc(tWidget* psWidget, uint32_t ui32Msg, uint32_t ui32Param1, uint32_t ui32Param2);
extern void CanvasInit(tCanvasWidget* psWidget, const tDisplay* psDisplay, int32_t i32X, int32_t i32Y, int32_t i32Width, int32_t i32Height);
