...
typedef struct
{
    ...
    //
    void (*pfnOnEvent)(tWidget* psWidget, uint32_t ui32Key, uint32_t ui32Event);
...
//
//*****************************************************************************
#define KEYBOARD_STYLE_TEXT_OPAQUE    0x00000010
...
//
//*****************************************************************************
#define KEYBOARD_STYLE_AUTO_REPEAT    0x00000020
...
//
//*****************************************************************************
#define KEYBOARD_STYLE_PRESS_NOTIFY   0x00000040
...
//
//*****************************************************************************
#define KEYBOARD_STYLE_RELEASE_NOTIFY 0x00000080
...
#define Keyboard(sName,                                         \
                 ...
                 psKeyboards,                                   \
                 pfnOnEvent)                                    \
    tKeyboardWidget sName = KeyboardStruct(psParent,            \
                                           psNext,              \
                                           psChild,             \
                                           psDisplay,           \
                                           i32X,                \
...
//
//*****************************************************************************
extern int32_t         KeyboardMsgProc(tWidget* psWidget, uint32_t ui32Msg, uint32_t ui32Param1, uint32_t ui32Param2);
extern void            KeyboardInit(tKeyboardWidget* psWidget,
