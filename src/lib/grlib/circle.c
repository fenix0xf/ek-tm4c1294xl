...
void GrCircleDraw(const tContext* pContext, int32_t i32X, int32_t i32Y, int32_t i32Radius)
{
    ...
    while (i32A <= i32B)
    {
        ...
        //
        if ((i32Y1 >= pContext->sClipRegion.i16YMin) && (i32Y1 <= pContext->sClipRegion.i16YMax))
        {
            //
            ...
            // at that position.
            //
            if ((i32X1 >= pContext->sClipRegion.i16XMin) && (i32X1 <= pContext->sClipRegion.i16XMax))
            {
        ...
        // subtracted).
        //
        if ((i32Y1 >= pContext->sClipRegion.i16YMin) && (i32Y1 <= pContext->sClipRegion.i16YMax) && (i32A != 0))
        {
            //
            // Determine the column when subtracting the B delta.
            //
