...
//
//*****************************************************************************
static void CanvasPaint(tWidget* psWidget)
{
    ...
    if (psCanvas->ui32Style & (CANVAS_STYLE_TEXT | CANVAS_STYLE_IMG))
    {
        ...
        if (psCanvas->ui32Style & CANVAS_STYLE_TEXT)
        {
            ...
            // Now draw the string.
            //
            GrStringDraw(&sCtx, psCanvas->pcText, -1, i32X, i32Y, psCanvas->ui32Style & CANVAS_STYLE_TEXT_OPAQUE);
        }
    }
...
//
//*****************************************************************************
int32_t CanvasMsgProc(tWidget* psWidget, uint32_t ui32Msg, uint32_t ui32Param1, uint32_t ui32Param2)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
void CanvasInit(tCanvasWidget* psWidget, const tDisplay* psDisplay, int32_t i32X, int32_t i32Y, int32_t i32Width, int32_t i32Height)
{
    uint32_t ui32Idx;
