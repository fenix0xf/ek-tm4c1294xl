...
#define CheckBox(sName,                                      \
                 ...
                 pui8Image,                                  \
                 pfnOnChange)                                \
    tCheckBoxWidget sName = CheckBoxStruct(psParent,         \
                                           psNext,           \
                                           psChild,          \
                                           psDisplay,        \
                                           i32X,             \
...
//
//*****************************************************************************
extern int32_t CheckBoxMsgProc(tWidget* psWidget, uint32_t ui32Msg, uint32_t ui32Param1, uint32_t ui32Param2);
extern void    CheckBoxInit(tCheckBoxWidget* psWidget,
