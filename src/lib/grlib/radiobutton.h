...
#define RadioButton(sName,                                         \
                    ...
                    pui8Image,                                     \
                    pfnOnChange)                                   \
    tRadioButtonWidget sName = RadioButtonStruct(psParent,         \
                                                 psNext,           \
                                                 psChild,          \
                                                 psDisplay,        \
                                                 i32X,             \
...
//
//*****************************************************************************
extern int32_t RadioButtonMsgProc(tWidget* psWidget, uint32_t ui32Msg, uint32_t ui32Param1, uint32_t ui32Param2);
