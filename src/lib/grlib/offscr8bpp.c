...
//
//*****************************************************************************
static uint32_t GrOffScreen8BPPColorTranslate(void* pvDisplayData, uint32_t ui32Value)
{
...
//
//*****************************************************************************
static void GrOffScreen8BPPPixelDraw(void* pvDisplayData, int32_t i32X, int32_t i32Y, uint32_t ui32Value)
{
    uint8_t* pui8Data;
...
//
//*****************************************************************************
static void GrOffScreen8BPPPixelDrawMultiple(void*          pvDisplayData,
                                             int32_t        i32X,
                                             int32_t        i32Y,
                                             int32_t        i32X0,
                                             int32_t        i32Count,
        ...
        case 1:
        {
            ...
            while (i32Count)
            {
                ...
                for (; (i32X0 < 8) && i32Count; i32X0++, i32Count--)
                {
                    ...
                    //
                    *pui8Ptr++ = (((uint32_t*)pui8Palette)[(ui32Byte >> (7 - i32X0)) & 1]);
                }
            ...
            switch (i32X0 & 1)
            {
                case 0:
                    while (i32Count)
                    {
                        ...
                        // screen.
                        //
                        *pui8Ptr++ = GrOffScreen8BPPColorTranslate(pvDisplayData, ui32Byte);
...
//
//*****************************************************************************
static void GrOffScreen8BPPLineDrawH(void* pvDisplayData, int32_t i32X1, int32_t i32X2, int32_t i32Y, uint32_t ui32Value)
{
    uint8_t* pui8Data;
    ...
    // a time).
    //
    ui32Value = (ui32Value << 24) | (ui32Value << 16) | (ui32Value << 8) | ui32Value;
...
//
//*****************************************************************************
static void GrOffScreen8BPPLineDrawV(void* pvDisplayData, int32_t i32X, int32_t i32Y1, int32_t i32Y2, uint32_t ui32Value)
{
    uint8_t* pui8Data;
...
//
//*****************************************************************************
static void GrOffScreen8BPPRectFill(void* pvDisplayData, const tRectangle* pRect, uint32_t ui32Value)
{
    ...
    // starting pixel.
    //
    pui8Data += (i32BytesPerRow * pRect->i16YMin) + pRect->i16XMin + 6 + (256 * 3);
    ...
    if (((uint32_t)pui8Data) & 1)
    {
        ...
        //
        for (i32Y = pRect->i16YMin, pui8Ptr = pui8Data; i32Y <= pRect->i16YMax; i32Y++, pui8Ptr += i32BytesPerRow)
        {
...
//
//*****************************************************************************
static void GrOffScreen8BPPFlush(void* pvDisplayData)
{
    //
    // Check the arguments.
    //
